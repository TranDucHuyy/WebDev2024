...
movieLists.forEach((movieList, i) => {
    ...
    // When hovering over the SEASON section, show the dropdown
    dropdown.addEventListener('mouseenter', showDropdown);

    // When moving the mouse out of the SEASON section, check if the mouse enters the dropdown content.
    dropdown.addEventListener('mouseleave', function(e) {
        // Delay hiding so the user has time to hover the dropdown
        setTimeout(function() {
    ...
    // Hide the dropdown only when the mouse leaves the dropdown content
